...
pub const OHLCWindow = struct {
    ...
    pub fn init(ticker: []const u8, shared_data: *SharedData) Self {
        return .{ .ticker = ticker, .shared_data = shared_data, .start_time = std.time.milliTimestamp() };
    }

    pub fn render(self: *Self, window: *Window(Self)) !void {
        // const ohlc_list = self.shared_data.ohlc.get(self.ticker) orelse return;
        var ohlc_list = OHLCList.init(std.heap.c_allocator);
        ...
        const opens = [_]f64{ 1284.7, 1319.9, 1318.7, 1328, 1317.6, 1321.6, 1314.3, 1325, 1319.3, 1323.1, 1324.7, 1321.3, 1323.5, 1322, 1281.3, 1281.95, 1311.1, 1315, 1314, 1313.1, 1331.9, 1334.2, 1341.3, 1350.6, 1349.8, 1346.4, 1343.4, 1344.9, 1335.6, 1337.9, 1342.5, 1337, 1338.6, 1337, 1340.4, 1324.65, 1324.35, 1349.5, 1371.3, 1367.9, 1351.3, 1357.8, 1356.1, 1356, 1347.6, 1339.1, 1320.6, 1311.8, 1314, 1312.4, 1312.3, 1323.5, 1319.1, 1327.2, 1332.1, 1320.3, 1323.1, 1328, 1330.9, 1338, 1333, 1335.3, 1345.2, 1341.1, 1332.5, 1314, 1314.4, 1310.7, 1314, 1313.1, 1315, 1313.7, 1320, 1326.5, 1329.2, 1314.2, 1312.3, 1309.5, 1297.4, 1293.7, 1277.9, 1295.8, 1295.2, 1290.3, 1294.2, 1298, 1306.4, 1299.8, 1302.3, 1297, 1289.6, 1302, 1300.7, 1303.5, 1300.5, 1303.2, 1306, 1318.7, 1315, 1314.5, 1304.1, 1294.7, 1293.7, 1291.2, 1290.2, 1300.4, 1284.2, 1284.25, 1301.8, 1295.9, 1296.2, 1304.4, 1323.1, 1340.9, 1341, 1348, 1351.4, 1351.4, 1343.5, 1342.3, 1349, 1357.6, 1357.1, 1354.7, 1361.4, 1375.2, 1403.5, 1414.7, 1433.2, 1438, 1423.6, 1424.4, 1418, 1399.5, 1435.5, 1421.25, 1434.1, 1412.4, 1409.8, 1412.2, 1433.4, 1418.4, 1429, 1428.8, 1420.6, 1441, 1460.4, 1441.7, 1438.4, 1431, 1439.3, 1427.4, 1431.9, 1439.5, 1443.7, 1425.6, 1457.5, 1451.2, 1481.1, 1486.7, 1512.1, 1515.9, 1509.2, 1522.3, 1513, 1526.6, 1533.9, 1523, 1506.3, 1518.4, 1512.4, 1508.8, 1545.4, 1537.3, 1551.8, 1549.4, 1536.9, 1535.25, 1537.95, 1535.2, 1556, 1561.4, 1525.6, 1516.4, 1507, 1493.9, 1504.9, 1506.5, 1513.1, 1506.5, 1509.7, 1502, 1506.8, 1521.5, 1529.8, 1539.8, 1510.9, 1511.8, 1501.7, 1478, 1485.4, 1505.6, 1511.6, 1518.6, 1498.7, 1510.9, 1510.8, 1498.3, 1492, 1497.7, 1484.8, 1494.2, 1495.6, 1495.6, 1487.5, 1491.1, 1495.1, 1506.4 };
        const highs = [_]f64{ 1284.75, 1320.6, 1327, 1330.8, 1326.8, 1321.6, 1326, 1328, 1325.8, 1327.1, 1326, 1326, 1323.5, 1322.1, 1282.7, 1282.95, 1315.8, 1316.3, 1314, 1333.2, 1334.7, 1341.7, 1353.2, 1354.6, 1352.2, 1346.4, 1345.7, 1344.9, 1340.7, 1344.2, 1342.7, 1342.1, 1345.2, 1342, 1350, 1324.95, 1330.75, 1369.6, 1374.3, 1368.4, 1359.8, 1359, 1357, 1356, 1353.4, 1340.6, 1322.3, 1314.1, 1316.1, 1312.9, 1325.7, 1323.5, 1326.3, 1336, 1332.1, 1330.1, 1330.4, 1334.7
.5, 1434.8, 1422.3, 1412.1, 1442.5, 1448.8, 1468.2, 1484.3, 1501.6, 1506.2, 1498.6, 1488.9, 1504.5, 1518.3, 1513.9, 1503.3, 1503, 1506.5, 1502.1, 1503, 1534.8, 1535.3, 1541.4, 1528.6, 1525.6, 1535.25, 1528.15, 1528, 1542.6, 1514.3, 1510.7, 1505.5, 1492.1, 1492.9, 1496.8, 1493.1, 1503.4, 1500.9, 1490.7, 1496.3, 1505.3, 1505.3, 1517.9, 1507.4, 1507.1, 1493.3, 1470.5, 1465, 1480.5, 1501.7, 1501.4, 1493.3, 1492.1, 1505.1, 1495.7, 1478, 1487.1, 1480.8, 1480.6, 1487, 1488.3, 1484.8, 1484, 1490.7, 1490.4, 1503.1 };
        ...
        const elapsed_blocks = @divTrunc(current_time - self.start_time, 250);

        // Create OHLC structs and append to the list
        for (dates, 0..) |_, i| {
            if (i > elapsed_blocks) break;
            const ohlc = shared_models.OHLC{
                .ticker = ManagedString.static("Test"),
                .trades = 0,
                .interval = 0,
                .timestamp = ManagedString.static("test"),
                .volume = 0,
                .timestamp_unix = @as(u64, @intFromFloat(dates[i])),
                .open = opens[i],
                .high = highs[i],
                .low = lows[i],
                .close = closes[i],
            };
            try ohlc_list.ohlc.append(ohlc);
        }
        ...
        if (imgui.igBegin(title, &window.popen, imgui.ImGuiWindowFlags_None)) {
            if (plot.ImPlot_BeginPlot(title, plot.ImVec2{ .x = -1, .y = 0 }, plot.ImPlotFlags_None)) {
                ...
                plot.ImPlot_SetupAxes(null, null, plot.ImPlotAxisFlags_AutoFit, plot.ImPlotAxisFlags_AutoFit | plot.ImPlotAxisFlags_RangeFit);
    ...
    fn plotCandlestick(
        ...
        bear_col: imgui.ImVec4,
    ) void {
        const count = ohlc_list.ohlc.items.len;
        const ohlc_slice = ohlc_list.ohlc.items;
        if (count == 0) return;
        ...
        if (plot.ImPlot_IsPlotHovered() and tooltip) {
            var mouse: plot.ImPlotPoint = undefined;
            plot.ImPlot_GetPlotMousePos(&mouse, plot.ImAxis_X1, plot.ImAxis_Y1);

            var plot_time: plot.ImPlotTime = undefined;
            plot.ImPlotTime_FromDouble(&plot_time, mouse.x);

            var rounded_time: plot.ImPlotTime = undefined;
            plot.ImPlot_RoundTime(&rounded_time, plot_time, plot.ImPlotTimeUnit_Day);

            mouse.x = plot.ImPlotTime_ToDouble(&rounded_time);

            var tool_l_pos: plot.ImVec2 = undefined;
            var tool_r_pos: plot.ImVec2 = undefined;
            plot.ImPlot_PlotToPixels_double(&tool_l_pos, mouse.x - half_width * 1.5, mouse.y, plot.ImAxis_X1, plot.ImAxis_Y1);
            plot.ImPlot_PlotToPixels_double(&tool_r_pos, mouse.x + half_width * 1.5, mouse.y, plot.ImAxis_X1, plot.ImAxis_Y1);

            const tool_l = tool_l_pos.x;
            const tool_r = tool_r_pos.x;

            var plot_pos: plot.ImVec2 = undefined;
            plot.ImPlot_GetPlotPos(&plot_pos);
            const tool_t = plot_pos.y;
            var plot_size: plot.ImVec2 = undefined;
            plot.ImPlot_GetPlotSize(&plot_size);
            const tool_b = tool_t + plot_size.y;

            plot.ImPlot_PushPlotClipRect(1);
            plot.ImDrawList_AddRectFilled(
                draw_list,
                plot.ImVec2{ .x = tool_l, .y = tool_t },
                plot.ImVec2{ .x = tool_r, .y = tool_b },
                imgui.igGetColorU32_U32(0x40808080, 1),
                0.0,
        ...
        if (plot.ImPlot_BeginItem(label_id.ptr, plot.ImPlotItemFlags_None, plot.ImPlotCol_Fill)) {
